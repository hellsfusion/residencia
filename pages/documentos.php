                        ...
                        <div class="card card-secondary <?= ($rowConfig == null ? 'collapsed-card' : null) ?>">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombre">Cargar Archivo</label>
                                            <input type="file" class="form-control" id="archivo" name="archivos[archivo|uploads/documentos/]" required value="<?= ($rowConfig != null ? $rowConfig['archivo'] : null) ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
