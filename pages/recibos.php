...
$idApartamento = ($_GET['iA'] ? base64_decode($_GET['iA']) : 0);
...
" . ($idCuotaExtra != 0 ? "and idCuotaExtra = '$idCuotaExtra'" : "") . "
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($rowData as $row) { ?>
                                        <tr style="background-color:<?= ($row['tipo_recibo'] == 'ingreso' ? 'rgba(0, 255, 0, 0.1)' : ($row['tipo_recibo'] == 'gasto' ? 'rgba(255, 0, 0, 0.1)' : ''))  ?>">
                                            <!-- <td style="width:2cm;"><?= $row['id'] ?></td> -->
                                            
                                            <td style="width:2cm;"><?= $row['fecha'] ?></td>
                                            <td style="width:2cm;"><?= date('Y-m-d', strtotime($row['fechaRegistro'])) ?> <?= $row['id'] ?></td>
                                            <td style="width:2cm;"><?= $row['tipo_recibo'] ?></td>

                                            <?php if ($row['tipo_recibo'] == 'ingreso') { ?>
                                                <td>
