...
$name = 'Recibos de Pago - Cuotas Extra';
$page = 'recibos';
...
" . ($idCuotaExtra != 0 ? "and idCuotaExtra = '$idCuotaExtra'" : "and (idCuotaExtra is not null and idCuotaExtra != '' and idCuotaExtra != 0) ") . "
";
// var_dump($query);
                                    ...
                                    <?php foreach ($rowData as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="m-0 p-0"><strong>Cuota Extra:</strong> <?= funcionMaster($row['idCuotaExtra'], 'id', 'descripcion', 'cuotasExtra') ?> </p>
                                                ...
                                                ?>
                                                <!-- <button class="btn btn-danger btn-sm btn-block" onclick="window.open('<?= $page ?>?FAID=<?= base64_encode($row['id']) ?>', '_blank');" title="Imprimir">
