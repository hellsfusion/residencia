    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form id="configForm">
                        <div class="card card-secondary <?= ($rowConfig == null ? '' : null) ?>">
                            <div class="card-header border-transparent">
                                <h3 class="card-title"><?= ($rowConfig != null ? '' : 'Registrar') ?></h3>
                            </div>
                            <div class="card-body">
                                <div class="row">                                    
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="descripcion" name="datos[descripcion]" required value="<?= ($rowConfig != null ? $rowConfig['descripcion'] : null) ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombre">Propietarios / Beneficiarios</label>
                                            <select name="datos[idApartamento][]" class="form-control select2 multiple" multiple id="idApartamento">
                                    ...
                                    <?php foreach ($rowData as $row) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 100px">
                                                <button class="btn btn-success btn-sm btn-block" onclick="window.open('<?= $Base ?>recibos?icE=<?= base64_encode($row['id']) ?>&iaF=<?= base64_encode($row['idApartamento']) ?>', '_self');" title="Recibos de Ingreso">
