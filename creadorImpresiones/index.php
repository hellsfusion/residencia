...
@page {
    ...
    ($rowConfig['AltoPapel'] != 0
        ? " size: " . $rowConfig['AnchoPapel'] . "cm " . $rowConfig['AltoPapel'] . "cm " . $rowConfig['orientacion'] . ";"
        : ""
    ) .
    ($rowConfig['orientacion'] == 'portrait' && $rowConfig['impresion'] == 'M' && $rowConfig['AltoPapel'] != 0
        ? 'margin-bottom: ' . (($rowConfig['AltoPapel'] / 2) - $rowConfig['MargenInferior']) . 'cm !important;'
        : ($rowConfig['orientacion'] == 'landscape' && $rowConfig['impresion'] == 'M' && $rowConfig['AltoPapel'] != 0
            ? 'margin-right: ' . (($rowConfig['AltoPapel'] / 2) - $rowConfig['MargenDerecho']) . 'cm !important;'
            : '')
    ) .
"}
